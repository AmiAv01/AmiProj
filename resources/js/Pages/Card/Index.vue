    ...
    <layout>
        ...
        <section class="py-6 bg-white md:py-10 antialiased">
            <div class="w-full max-w-8xl px-6 mx-auto">
                <!-- Сетка flex с выравниванием высоты элементов items-stretch -->
                <div class="flex flex-col lg:flex-row gap-8 items-stretch">

                    <!-- Левый блок: Основная карточка товара (центрирует контент по вертикали при скрытой деталировке) -->
                                ...
                                <div class="flex items-center justify-between border-t pt-4" v-if="!isEmpty">
                                    <div>
                                        ...
                                        <p class="text-2xl font-extrabold text-gray-900 mt-1">
                                            {{ (price !== '0' && price !== undefined) ? `${price} BYN` : 'цену уточнять' }}
                                        </p>
                                    </div>
                                </div>
                    ...
                    <!-- Правый блок: Найденные аналоги (с ограничением высоты и прокруткой) -->
